...
export class Backend implements backendInterface {
    ...
    async changePassword(arg0: string, arg1: string): Promise<string> {
    ...
    async deleteArticle(arg0: bigint, arg1: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async publishArticle(arg0: string, arg1: string, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.publishArticle(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
